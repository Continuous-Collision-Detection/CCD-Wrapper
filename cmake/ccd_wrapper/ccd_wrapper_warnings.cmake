...
if(TARGET ccd_wrapper::warnings)
	return()
endif()

set(CCD_WRAPPER_FLAGS
	-Wall
	-Wextra
	-pedantic
...
add_library(ccd_wrapper_warnings INTERFACE)
add_library(ccd_wrapper::warnings ALIAS ccd_wrapper_warnings)

foreach(FLAG IN ITEMS ${CCD_WRAPPER_FLAGS})
	...
	if(IS_SUPPORTED_${FLAG_VAR})
		target_compile_options(ccd_wrapper_warnings INTERFACE ${FLAG})
	endif()
endforeach()
