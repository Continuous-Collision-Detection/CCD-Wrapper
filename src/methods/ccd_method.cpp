#include "ccd_method.hpp"

namespace ccd {

bool CCDMethod::point_triangle_ccd(
...
static std::shared_ptr<CCDMethod> get_method(const std::string& method_name) { }
